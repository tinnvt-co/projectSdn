            ...
            <div className="modal-box" onClick={(event) => event.stopPropagation()}>
                ...
                <form onSubmit={handleSubmit} className="review-form">
                    <div className="form-row">
                        <label>Ghi chú phản hồi (tùy chọn)</label>
                        <textarea rows={4} placeholder="Nhập phản hồi gửi lại cho quản lý..." value={note} onChange={(event) => setNote(event.target.value)} />
                    </div>
